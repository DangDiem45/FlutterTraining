...
mixin _$ProductModel {
 ...
 int get id; String get title; double get price; String get description; String get category; String get img; RatingModel get rating;
...
@override
String toString() {
  return 'ProductModel(id: $id, title: $title, price: $price, description: $description, category: $category, img: $img, rating: $rating)';
}
...
@useResult
$Res call({
 int id, String title, double price, String description, String category, String img, RatingModel rating
});
...
class _ProductModel implements ProductModel {
  const _ProductModel({required this.id, required this.title, required this.price, required this.description, required this.category, required this.img, required this.rating});
